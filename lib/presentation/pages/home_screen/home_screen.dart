...
import 'package:retrash_app/presentation/pages/presents_screen/presents_screen.dart';
import 'package:retrash_app/presentation/pages/qr_screen/qr_screen.dart';
...
class _TabPages extends StatelessWidget {
  ...
  static List<Widget> _buildTabs() {
    return <Widget>[
      Navigator(
        key: ValueKey('Presents screen'),
        onGenerateRoute: (_) {
          return MaterialPageRoute(builder: (_) => PresentsScreen());
        },
      ),
      Navigator(
        key: ValueKey('Map screen'),
        onGenerateRoute: (_) {
          return MaterialPageRoute(builder: (_) => MapScreen());
        },
      ),
      Navigator(
        key: ValueKey('Qr screen'),
        onGenerateRoute: (_) {
